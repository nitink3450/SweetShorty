      ...
      {/* <div className="flex mt-[20px] lg:mt-[50px] justify-center items-center"> */}
        <div className="w-full bg-white">
          {/* <div className="container mx-auto"> */}
            <div className="max-w-3xl mx-auto my-10 bg-white p-5 rounded-md ">
              <div className="text-center">
                <h1 className="lg:text-[40px] w-full md:text-[30px] text-center text-[25px] font-semibold text-[#232127] lg:tracking-[-3px] tracking-[-1px] leading-[0.9] mb-[10px]">
